...
read_metrics_evaluation_per_sample(ITERATION, "all", FALSE)
...
read_metrics_evaluation_per_sample(ITERATION, "selected", FALSE)
merge_and_matthews_correlation(FALSE)
...
read_metrics_evaluation_per_sample(ITERATION, "combined", TRUE)
merge_and_matthews_correlation(TRUE)
...
read_metrics_evaluation_per_sample(ITERATION, "default", TRUE)
merge_and_matthews_correlation(TRUE)
